#!/bin/bash
./gavrasm/gavrasm ws2801_cycle.asm
# Fuses
...
sudo ~/arduino-1.6.6/hardware/tools/avr/bin/avrdude -p attiny85 -C ~/arduino-1.6.6/hardware/tools/avr/etc/avrdude.conf -c usbtiny -U flash:w:ws2801_cycle.hex:i
